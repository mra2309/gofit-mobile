...
interface ApiService {
    ...
    @GET("api/booking_gyms")
    fun getBookingGym() :Call<BookingGymResponse>

    @POST("api/booking_gyms")
    fun saveBookingGym(@Body request: BookingFormRequest):Call<BookingFormResponse>
}